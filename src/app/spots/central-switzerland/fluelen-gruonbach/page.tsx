...
export const metadata: Metadata = {
  title: 'Flüelen Gruonbach, Uri - Windsurf Spot Guide & Forecast',
}

export default function FluelenGruonbach() {
  return (
    <>
        <NavbarLight/>
                                    ...
                                    <div className="listingFirstinfo d-flex align-items-center justify-content-start gap-3 flex-wrap">
                                        <div className="listingCaptioninfo">
                                            <div className="propertyTitlename d-flex align-items-center gap-2 mb-1">
                                                <h2 className="fw-semibold text-light mb-0">Flüelen Gruonbach</h2>
                                            </div>
                    ...
                    <div className="col-12">
                        ...
                        <div className="listingSingleblock mb-4" id="windy">
                            ...
                            <div id="windyPanel" className="panel-collapse collapse show">
                                <div className="card-body p-4 pt-2">
                                    <WindyEmbed lat={46.928} lon={8.604} title="Flüelen Gruonbach Wind Map" />
                                </div>
                            </div>
                        </div>
